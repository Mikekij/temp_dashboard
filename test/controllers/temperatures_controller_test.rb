...
class TemperaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create temperature" do
    assert_difference('Temperature.count') do
      post temperatures_url, params: { temperature: { temperature_c: @temperature.temperature_c, thermometer_id: @temperature.thermometer_id } }
    end
  ...
  test "should update temperature" do
    patch temperature_url(@temperature), params: { temperature: { temperature_c: @temperature.temperature_c, thermometer_id: @temperature.thermometer_id } }
